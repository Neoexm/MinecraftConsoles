...
HttpResponse WinsockNetLayer::DoWinHttpRequest(const wchar_t* host, int port, const std::wstring& path, const wchar_t* method, const std::string& requestData, const std::vector<std::wstring>& headers)
{
